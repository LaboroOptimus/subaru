...
const Content: React.FC<Props> = ({ product }) => {
  ...
  return (
    <>
      ...
      <p>
        Enhance your Ascent audio system to a new level of sound quality so you
        not only hear the music, but feel it. The Rockford Fosgate® Audio
        Upgrade consists of an amplifier, upgraded speakers and an integrated
        digital signal processor tuned to align the system to the listener's
        preference. Not applicable to models with Harman Kardon® Premium Audio
